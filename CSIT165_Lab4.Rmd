...
top5_unaccounted <- unaccounted_tally[order(unaccounted_tally$Total_unaccounted, decreasing = TRUE),] 

top5_unaccounted <- head(top5_unaccounted, 5)
...
# Use built-in dataset: state.x77
...
treemap(state_data,
        index = "State",             # Label by state
        vSize = "Population",        # Size by population
